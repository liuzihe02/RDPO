...
#you may need to vary this to the homedir or the scratchdir
# export TRITON_CACHE_DIR="/scratch0/zachliu/.triton/autotune"
...
CONFIG_FILE="../scripts/train-qwen2.5-0.5b-genrm-rdpo/train.yaml"
