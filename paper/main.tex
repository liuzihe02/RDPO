...
The three defining features of Method~1 are: \textbf{(A)} a DPO loss on answer preferences $(y_w, y_l)$; \textbf{(B)} an NLL term on the verifier's CoT critique $c_v$; and \textbf{(C)} applied to the base policy model. No single prior work combines all three.
...
\begin{center}
    ...
    \begin{tabular}{lccc}
        ...
        \hline
        \textbf{Method~1 (this work)}                                                                              & \checkmark                 & \checkmark                      & \checkmark             \\
